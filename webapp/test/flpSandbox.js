					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "DMS Reuse Fiori App",
									"targetURL": "#reuseuidms-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"reuseuidms-display": {
								"semanticObject": "reuseuidms",
								"action": "display",
								"description": "DMS Reuse Fiori App",
								"title": "DMS Reuse Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=reuseuidms",
									"url": sap.ui.require.toUrl("reuseuidms")
								}
							}
						}
					}
